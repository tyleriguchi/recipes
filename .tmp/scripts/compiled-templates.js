...
function program3(depth0,data) {
  ...
  stack2 = ((stack1 = helpers['link-to'] || depth0['link-to']),stack1 ? stack1.call(depth0, "recipe.edit", "model", options) : helperMissing.call(depth0, "link-to", "recipe.edit", "model", options));
...
Ember.TEMPLATES["recipe/edit"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
...
Ember.TEMPLATES["recipe/index"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
  


  data.buffer.push("<p>recipes route is working</p>\n");
...
function program1(depth0,data) {
  ...
  stack2 = ((stack1 = helpers['link-to'] || depth0['link-to']),stack1 ? stack1.call(depth0, "recipe", "", options) : helperMissing.call(depth0, "link-to", "recipe", "", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("</li>\n  ");
  return buffer;
  }
function program2(depth0,data) {
  ...
  data.buffer.push("<h1>Recipes</h1>\n\n<ul>\n ");
  hashTypes = {};
  hashContexts = {};
